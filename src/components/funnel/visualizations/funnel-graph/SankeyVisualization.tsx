...
import { TrendingUp, TrendingDown, Users, Target, ZoomIn, ZoomOut, RotateCcw, Tag as TagIcon, X, Check } from 'lucide-react';
...
export const SankeyVisualization: React.FC<SankeyVisualizationProps> = ({
  ...
  const handleCreateTag = () => {
    ...
    // Re-open the select so the new tag is visible for selection
